...
router.get("/get-user", (0, auth_1.auth)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN, client_1.UserRole.DOCTOR, client_1.UserRole.PATIENT), User_controller_1.UserController.getUser);
router.patch("/", User_controller_1.UserController.userSoftDelete);
router.post("/create-admin", 
// auth(UserRole.SUPER_ADMIN, UserRole.ADMIN),
fileUploader_1.fileUploader.upload, (req, res, next) => {
